<template>
  <div id="app">
    ...
    <div class="info-box">
      <div><span>blockStyle: </span>{{selection.blockStyle}}</div>
      <div><span>inlineStyles: </span>{{selection.inlineStyles}}</div>
      <div><span>offset: </span>{{selection.startOffset}}, {{selection.endOffset}}</div>
    </div>
  </div>
</template>
